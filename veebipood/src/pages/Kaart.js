...
function Kaart() {
    ...
    return (
        <div>
            ...
            <button onClick={() => setPosition({center: [59.427, 24.723], zoom: 13})}>Kristiine</button>
            ...
            <button onClick={() => setPosition({center: [58.370, 24.549], zoom: 13})}>Kaubamajakas</button>
            <button onClick={() => setPosition({center: [58.358, 26.677], zoom: 13})}>Lõunakeskus</button>
        ...
        <MapContainer style={{"height": "300px", "margin": "3%", "border-radius": "10px"}} center={position.center} zoom={position.zoom} scrollWheelZoom={false}>
          ...
          <Marker position={[58.370, 24.549]}>
            <Popup>
              Kaubamajakas <br /> Avatud 9-22.
            </Popup>
          </Marker>

          <Marker position={[58.358, 26.677]}>
            <Popup>
              Lõunakeskus <br /> Avatud 9-22.
            </Popup>
          </Marker>
